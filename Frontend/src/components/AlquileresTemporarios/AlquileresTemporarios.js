      ...
      (rental.bookings || []).map((b, i) =>
        e('div', { key: i, className: 'booking-item' },
          e('div', { className: 'booking-item-main' },
            ...
            e('span', { className: 'booking-item-dates' }, e(Icons.Calendar, { width: 12, height: 12 }), `${b.startDate?.slice(0, 10)} → ${b.endDate?.slice(0, 10)}`),
            e('button', { type: 'button', className: 'btn ghost xs danger', title: 'Eliminar reserva', onClick: () => removeBooking(i) }, e(Icons.Trash, { width: 12, height: 12 })),
          ),
          (b.guestName || b.guestPhone) && e('div', { className: 'booking-item-contact' },
            ...
            b.guestPhone && e('span', null, e(Icons.Phone, { width: 12, height: 12 }), b.guestPhone),
          ),
