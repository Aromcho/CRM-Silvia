          ...
          groups: [
            {
              ...
              rows: [
                ...
                e(Row, { key: 'aptocredito', label: 'Apto crédito', icon: Icons.Check },
                  e('label', { className: `services-editor-item${property.aptoCredito ? ' checked' : ''}` },
                    e('input', {
                      type: 'checkbox', checked: !!property.aptoCredito,
                      onChange: () => saveField('aptoCredito', !property.aptoCredito),
                    }),
                    e('span', null, property.aptoCredito ? 'Sí' : 'No'),
                  ),
                ),
                e(Row, { key: 'aptofinanciacion', label: 'Apto financiación', icon: Icons.DollarSign },
                  e('label', { className: `services-editor-item${property.aptoFinanciacion ? ' checked' : ''}` },
                    e('input', {
                      type: 'checkbox', checked: !!property.aptoFinanciacion,
                      onChange: () => saveField('aptoFinanciacion', !property.aptoFinanciacion),
                    }),
                    e('span', null, property.aptoFinanciacion ? 'Sí' : 'No'),
                  ),
                ),
              ],
            },
