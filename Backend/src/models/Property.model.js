...
const propertySchema = new Schema({
  ...
  // Una vez presente, syncWithTokko.js deja de reconstruir `photos` para esta propiedad (si no,
  // cada sync pisaba el array editado a mano con el set completo/orden original de Tokko).
  photosEditedAt: Date,
  ...
  difusion: {
    mercadolibre: {
      ...
      listings: [{
        ...
        health_actions: [{ id: String, title: String, description: String, cta: String }], // objetivos pendientes, mismo formato que el widget "Calidad de tu publicación" de ML
